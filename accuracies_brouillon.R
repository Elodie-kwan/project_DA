...
cbind(rbind(cm_bigct$overall, cm_bigct$byClass[11]),
      rbind(cm_ctprune$overall, cm_ctprune$byClass[11]),
      rbind(cm_ctautoprune$overall, cm_ctautoprune$byClass[11]),
      rbind(cm_logreg$overall, cm_logreg$byClass[11]), 
      rbind(cm_logregsel$overall, cm_logregsel$byClasss[11]),
      # cm_knn2$overall,
      # cm_knn3$overall,
      rbind(cm_linearsvm$overall, cm_linearsvm$byClasss[11]),
      rbind(cm_linearsvm_tuned$overall, cm_linearsvm_tuned$byClasss[11]), 
      rbind(cm_rbsvm$overall, cm_rbsvm$byClasss[11]),
      rbind(cm_rbsvm_tuned$overall, cm_rbsvm_tuned$byClasss[11]),
      rbind(cm_nn3$overall, cm_nn3$byClasss[11]) , 
      rbind(cm_xgb$overall, cm_xgb$byClasss[11])
      )
...
# that the **Precision** is relatively low (0.4531250) meaning that from all the classes we have predicted as positive, only 45% are actually positive.
