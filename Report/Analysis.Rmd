...
). We recall that 0 means a "Bad Credit" risk and 1 means a "Good Credit" risk. It seems that it has difficulty to predict the "Bad Credit" risk applicants. 
...
Once all the models were modelized we have to compare them according to their scores and metrics. Below we summarized all their accuracy into one table. 


```{r echo=FALSE}
models_stat <- cbind(cm_bigct$overall,
                     cm_ctprune$overall,
...
kable(models_stat, digits = 4, caption = "Scores of the models") %>% 
...
kable(KNNmodels_stat, digits = 4, caption = "Scores of the KNN models")
```
