...
In the end, we get the most significant model: RAPPEL (Comment variable per variable)
...
Here we have an accuracy of 68.8%. It is good but there is room for improvement. 
