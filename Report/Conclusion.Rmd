...
The goal aslo for the banker is not to loan to a 'Bad credits' that he classified initially as a 'Good credit'. It means that as an indicator of model selection it would be intersting to go for the model that has the highest specificity. And thus prioritize the **True 'Good Credits' rate**.
